...
<head>
    ...
    <style>
        ...
        .header .logo-text { /* Estilo para el texto del logo "Gestión de Marcas" */
            font-size: 22px;
            color: var(--text);
        ...
        /* Estilos del CRUD de Marcas (originales de tu archivo - se mantienen) */
        .container-main {
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="ServletMarcas" class="menu__item active"> <!-- MARCAS ACTIVO -->
                <i class='bx bx-building-house'></i><span>Marcas</span> <!-- Icono de Marcas corregido -->
            </a>
    ...
    <main class="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark mb-4">
            <div class="container-fluid">
                ...
                <span class="navbar-text ms-3 h4" style="color: black !important;">Gestión de Marcas</span>
            </div>
        </nav>
            ...
            <div class="container-main">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div> <!-- Contenedor para los botones -->
                        <button type="button" class="btn btn-add me-2" data-bs-toggle="modal" data-bs-target="#marcaModal" onclick="prepararModalAgregar()">
                            <i class="bi bi-plus-circle"></i> Agregar Marca
                        </button>
                        <!-- Nuevo botón para descargar el reporte -->
                        <a href="${pageContext.request.contextPath}/ServletReportes?nombre=marcas" class="btn btn-report" target="_blank">
