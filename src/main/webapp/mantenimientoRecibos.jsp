    ...
    <body>
        ...
        <aside class="sidebar">
            ...
            <nav class="menu">
                ...
                <a href="ServletRecibos" class="menu__item active"> <!-- RECIBOS ACTIVO -->
                                            ...
                                            <tr data-codigo="${recibo.codigoRecibo}"
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${rol == 'Admin' or rol == 'Usuario'}">
                                                        <a href="${pageContext.request.contextPath}/ServletRecibos?accion=eliminar&id=${recibo.codigoRecibo}" class="btn btn-delete btn-sm" onclick="return confirm('¿Está seguro de eliminar este recibo?');">Eliminar</a>
                                                    </c:if>
                                                </td>
                                            </tr>
                                        </c:forEach>
