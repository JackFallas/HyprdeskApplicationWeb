...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .header .logo-text { /* Estilo para el texto del logo "Gestión de Recibos" */
                font-size: 22px;
                color: var(--text);
            ...
            /* Estilos del CRUD de Recibos (originales de tu archivo - se mantienen) */
            .container-main {
    ...
    <body>
        ...
        <aside class="sidebar">
            ...
            <nav class="menu">
                ...
                <a href="ServletRecibos" class="menu__item active"> <i class='bx bx-receipt'></i><span>Recibos</span>
                </a>
        ...
        <main class="main-content">
            <nav class="navbar navbar-expand-lg navbar-dark mb-4">
                <div class="container-fluid">
                    ...
                    <span class="navbar-text ms-3 h4" style="color: black !important;">Gestión de Recibos</span>
                </div>
            </nav>
                                    ...
                                    <c:when test="${not empty listaRecibos}">
                                        <c:forEach var="recibo" items="${listaRecibos}">
                                            <tr data-codigo="${recibo.codigoRecibo}"
                                                ...
                                                <td>
                                                    <c:if test="${rol == 'Admin'}">
                                                        <button type="button" class="btn btn-edit btn-sm me-2" data-bs-toggle="modal" data-bs-target="#reciboModal" onclick="prepararModalEditar(this)">
                                                            Editar
                                                        </button>
                                                    </c:if>
                                                    ...
                                                    <c:if test="${rol == 'Admin' or rol == 'Usuario'}">
                                                        <a href="${pageContext.request.contextPath}/ServletRecibos?accion=eliminar&id=${recibo.codigoRecibo}"
                                                           class="btn btn-delete btn-sm" onclick="return confirm('¿Está seguro de eliminar este recibo?');">
                                                            Eliminar
                                                        </a>
                                                    </c:if>
                                                </td>
